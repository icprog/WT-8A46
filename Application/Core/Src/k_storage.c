...
char mSDDISK_Drive[4];       /* SD logical drive number */
...
void k_StorageInit(void)
{
  ...
  osThreadDef(STORAGE_Thread, StorageThread, osPriorityAboveNormal, 0, 2 * configMINIMAL_STACK_SIZE);
...
{
  if(BSP_SD_IsDetected() == 1)	//1-SD_PRESENT, 0-SD_NOT_PRESENT
  {
